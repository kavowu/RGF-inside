...
const ZM = {
  ...
  Me = {
    ...
    poster: "./assets/視覺圖.webp",
    nbaf: "./assets/生物防護脈絡.jpg",
    pathogenBrochure:
      "./assets/多病原測試文宣.webp",
    timeline: "./assets/大事紀原始附件圖.webp",
    anthrax: "./assets/環境淨化器郵包炭疽故事附件.jpg",
    tripleCertifications: "./assets/通過台美中三地防疫技術認證佐證圖.webp",
    presidentialTrip:
      "./assets/指定場域防護.jpg",
  },
  WM = [
